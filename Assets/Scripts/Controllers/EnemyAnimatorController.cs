...
namespace Platformer
{
    public class EnemyAnimatorController
    {
        ...
        public void StartAnimation(SpriteRenderer sprite, EnemyAnimState track, bool loop, float speed)
        {
