...
namespace Platformer
{
    public class PlayerAnimatorController : IDisposable
    {
        ...
        public PlayerAnimatorController(PlayerAnimatorConfig config)
        {
            _config = config;
        }
        ...
        public void StartAnimation(SpriteRenderer sprite, PlayerAnimState track, bool loop, float speed)
        {
